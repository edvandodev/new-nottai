      ...
      <div className='text-center space-y-6'>
        ...
        <div className='bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3 text-left flex gap-3'>
          ...
          <p className='text-sm text-yellow-200/80'>
            Ao confirmar, o saldo será zerado e um registro será criado na aba
            de <strong>Pagamentos</strong>.
          </p>
        </div>
      ...
      <div className='text-center space-y-6'>
        ...
        <div>
          ...
          <p className='text-slate-400'>
            O pagamento de{' '}
            <span className='text-white font-semibold'>{clientName}</span> foi
            salvo com sucesso.
          </p>
