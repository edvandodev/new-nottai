...
export function PriceHeroCard({ valueLabel, subtitle, onEdit }: PriceHeroCardProps) {
  return (
    <div className='relative overflow-hidden rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900/90 via-slate-900 to-slate-950 shadow-[0_10px_40px_-25px_rgba(0,0,0,0.8)]'>
      ...
      <div className='relative px-5 py-4 flex items-center justify-between gap-4'>
        <div>
          ...
          <div className='mt-1 text-3xl font-bold text-white leading-tight'>{valueLabel}</div>
